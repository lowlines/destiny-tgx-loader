(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('fs'), require('node-fetch'), require('path')) :
    typeof define === 'function' && define.amd ? define(['exports', 'fs', 'node-fetch', 'path'], factory) :
    (global = global || self, factory(global.TGXLoader = {}, global.fs, global.fetch, global.path));
}(this, function (exports, fs, fetch, path) { 'use strict';
